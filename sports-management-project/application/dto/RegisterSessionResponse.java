...
public class RegisterSessionResponse {
    ...
    public RegisterSessionResponse(SessionId sessionId, UUID athleteId, LocalDateTime sessionDate,
                                   int durationMinutes, Intensity intensity, FatigueLevel fatigueLevel,
                                   Routine recommendedRoutine, RecoverySuggestion recoverySuggestion,
