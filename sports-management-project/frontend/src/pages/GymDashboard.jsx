        ...
        <div className="dashboard-grid">
          <div className="dashboard-card">
            ...
            <div className="profile-info">
              ...
              <p><strong>Deporte:</strong> Gimnasio</p>
                    ...
                    <div className="recovery-box">
                      ...
                      <p className="recovery-text">
                        {s.recoverySuggestion === 'ABSOLUTE_REST' ? 'DESCANSO ABSOLUTO - Tu cuerpo necesita descanso completo' : 
                         ...
                         s.recoverySuggestion === 'ACTIVE_RECOVERY' ? 'RECUPERACIÓN ACTIVA - Movimientos suaves de baja intensidad' : 
            ...
            <div className="service-card-visual">
              ...
              <div className="service-content">
                ...
                <div className="example-box">
                  ...
                  <p>Sesión: 60 minutos × Intensidad Alta (3x)</p>
                  <p>60 ÷ 10 = 6 puntos base</p>
                  <p>6 × 3 = 18 puntos</p>
                  ...
                  <table>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Gimnasio</td>
                        <td>Rutina Intensa Gym (60 min, Alta)</td>
                      </tr>
                      <tr>
              ...
              <div className="service-content">
                ...
                <div className="recovery-cards">
                  ...
                  <div className="recovery-card-item medium">
                    <div className="recovery-emoji">🚶</div>
                    <h4>Fatiga MEDIA</h4>
                    <p className="recovery-action">ACTIVIDAD LIGERA / RECUPERACIÓN ACTIVA</p>
                    <p className="recovery-desc">Caminata, estiramiento o ejercicios suaves.</p>
                  </div>
