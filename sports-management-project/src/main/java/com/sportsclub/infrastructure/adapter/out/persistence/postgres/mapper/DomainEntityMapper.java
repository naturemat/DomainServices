...
public class DomainEntityMapper {
    public Athlete toDomain(AthleteEntity entity) {
        if (entity == null)
            return null;
        return new Athlete(entity.getId(), entity.getName(), mapSportType(entity.getSportType()), entity.getBirthDate(),
                entity.getCreatedAt());
    }
    ...
    public TrainingSession toDomain(TrainingSessionEntity entity) {
        if (entity == null)
            return null;
        return new TrainingSession(SessionId.from(entity.getSessionId()), entity.getAthleteId(),
                entity.getSessionDate(), entity.getDurationMinutes(), mapIntensity(entity.getIntensity()),
                entity.getCaloriesBurned(), entity.getCreatedAt());
    }
    ...
    public Routine toDomain(RoutineEntity entity) {
        if (entity == null)
            return null;
        return new Routine(entity.getId(), entity.getAthleteId(), entity.getName(), entity.getDescription(),
                entity.getRecommendedDurationMinutes(), mapRoutineIntensity(entity.getRecommendedIntensity()),
                mapRecoverySuggestion(entity.getRecoverySuggestion()), entity.getCreatedAt());
    }
    ...
    private SportType mapSportType(AthleteEntity.SportTypeEnum e) {
        return e == null ? null : SportType.valueOf(e.name());
    }

    private AthleteEntity.SportTypeEnum mapSportTypeToEnum(SportType s) {
        return s == null ? null : AthleteEntity.SportTypeEnum.valueOf(s.name());
    }

    private Intensity mapIntensity(TrainingSessionEntity.IntensityEnum e) {
        return e == null ? null : Intensity.valueOf(e.name());
    }

    private TrainingSessionEntity.IntensityEnum mapIntensityToEnum(Intensity i) {
        return i == null ? null : TrainingSessionEntity.IntensityEnum.valueOf(i.name());
    }

    private Intensity mapRoutineIntensity(RoutineEntity.IntensityEnum e) {
        return e == null ? null : Intensity.valueOf(e.name());
    }

    private RoutineEntity.IntensityEnum mapRoutineIntensityToEnum(Intensity i) {
        return i == null ? null : RoutineEntity.IntensityEnum.valueOf(i.name());
    }

    private RecoverySuggestion mapRecoverySuggestion(RoutineEntity.RecoverySuggestionEnum e) {
        return e == null ? null : RecoverySuggestion.valueOf(e.name());
    }

    private RoutineEntity.RecoverySuggestionEnum mapRecoverySuggestionToEnum(RecoverySuggestion s) {
        return s == null ? null : RoutineEntity.RecoverySuggestionEnum.valueOf(s.name());
    }
}