...
public class RoutineResponse {
    ...
    public static RoutineResponse fromDomain(Routine routine, String athleteName) {
        ...
        response.id = routine.getId(); response.athleteId = routine.getAthleteId(); response.athleteName = athleteName;
        response.name = routine.getName(); response.description = routine.getDescription();
        response.recommendedDurationMinutes = routine.getRecommendedDurationMinutes();
        response.recommendedIntensity = routine.getRecommendedIntensity(); response.recoverySuggestion = routine.getRecoverySuggestion();
        return response;
    }
