...
public class FatigueRules {
    ...
    public FatigueRules() { this(72, 30, 15, 1); }
    public FatigueRules(int recoveryWindowHours, int highFatigueThreshold, int mediumFatigueThreshold, int restDayReductionRate) {
